    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav" v-if="isAuth">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown" v-if="staff.position === 'admin'">
            <a 
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li>
                <router-link 
                  to="/services/book-recommendations" 
                  class="dropdown-item">
                    Dịch Vụ Đề Xuất Sách
                  </router-link>
              </li>
              <li>
                <router-link 
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li>
                <router-link 
                  to="/admin/services/book-borrowings" 
                  class="dropdown-item">
                    Dịch Vụ Mượn Trả Sách
                </router-link>
              </li>
              <li>
                <router-link 
                  to="/admin/services/reservations" 
                  class="dropdown-item">
                    Dịch Vụ Đặt Trước Sách
                </router-link>
              </li>
              <li>
                <router-link 
                  to="/admin/services/book-recommendations" 
                  class="dropdown-item">
                    Dịch Vụ Đề Xuất Sách
                  </router-link>
              </li>
          ...
          <li class="nav-item dropdown" v-if="staff.position === 'admin'">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li>
                <router-link to="/admin/users/reader" class="dropdown-item">Quản Lý Độc Giả</router-link>
              </li>
              <li>
                <router-link to="/admin/users/librarian" class="dropdown-item">Quản Lý Thủ Thư</router-link>
              </li>
            </ul>
          </li>
        </ul>
      ...
      <div class="d-flex align-items-center" v-if="isAuth">
        <!-- Hiển thị tên người dùng và icon người dùng -->
        <span class="text-dark me-2">{{ staff.fullname }}</span> <!-- Tên người dùng -->
        <i class="fas fa-user-circle me-2" style="font-size: 24px;"></i> <!-- Icon người dùng -->
        <button @click="logout" class="btn btn-outline-info d-flex align-items-center">
          <i class="fas fa-sign-out-alt"></i> <!-- Icon đăng xuất -->
        </button>
      </div>
    </div>
  </nav>
